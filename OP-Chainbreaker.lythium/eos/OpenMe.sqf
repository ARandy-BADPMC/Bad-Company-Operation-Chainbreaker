...
null = [["mkr135"],[3,1,70],[1,2,50],[1,1,20],[1,5],[2,50],[0,0,0],[5,0,300,EAST,FALSE]] call EOS_Spawn;
null = [["mkr136"],[3,1,70],[1,2,50],[1,1,20],[1,5],[2,50],[0,0,0],[5,0,300,EAST,FALSE]] call EOS_Spawn;
null = [["mkr137"],[3,1,70],[1,2,50],[1,1,20],[1,5],[2,50],[0,0,0],[5,0,300,EAST,FALSE]] call EOS_Spawn;
...
null = [["mkr141"],[3,1,70],[1,2,50],[1,1,20],[1,5],[2,50],[0,0,0],[5,0,300,EAST,FALSE]] call EOS_Spawn;
...
null = [["mkr147"],[3,1,70],[1,2,50],[1,1,20],[1,5],[2,50],[0,0,0],[5,0,300,EAST,FALSE]] call EOS_Spawn;
...
null = [["mkr152"],[3,1,70],[1,2,50],[1,1,20],[1,5],[2,50],[0,0,0],[5,0,300,EAST,FALSE]] call EOS_Spawn;
