params ["_centerobj", "_groupsToSpawn", "_tanksToSpawn","_mechToSpawn","_choppersToSpawn"];
...
if (_choppersToSpawn != 0) then {
	for "_i" from 1 to _choppersToSpawn do {
		_randomDistance = 0;
		...
		_groupNumber = [_spawnPos,random 360,selectrandom _choppers,east] call BIS_fnc_spawnVehicle;
