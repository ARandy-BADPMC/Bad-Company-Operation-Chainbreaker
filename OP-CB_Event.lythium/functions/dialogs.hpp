class jey_adminconsole_dialog 
{
	...
	class controls 
	{
		...
		class jey_restart: RscButton
		{
			...
			h = 0.0659743 * safezoneH;
			action = "remoteExec ['jey_restart',2]";
		};
		class jey_spectator: RscButton
		{
			...
			w = 0.0572917 * safezoneW;
			h = 0.0659743 * safezoneH;
			action = "[] spawn jey_spectate;closeDialog 0";
		};
		class jey_restart_server: RscButton
		{
			...
			w = 0.0572917 * safezoneW;
			h = 0.0659743 * safezoneH;
			action = "remoteExec ['jey_restart_server',2]";
		};
...
class jey_helispawner 
{
	...
	class controls 
	{
		...
		class heli_list: RscListbox
		{
			...
			onLBSelChanged  = "[] spawn jey_heli_loadouts;";
		};
		...
		class heli_spawn: RscButton
		{
			...
			action = "[] spawn jey_spawn_heli_vehicle;";
		};
	};
};
class jey_tankspawner 
{
	...
	class controls 
	{
		...
		class heli_spawn: RscButton
		{
			...
			w = 0.0458333 * safezoneW;
			h = 0.0593768 * safezoneH;
			action = "[] spawn jey_spawn_tank_vehicle;";
		};
	};
};
...
class jey_remover
{
	...
	class controls 
	{
		...
		class remove_delete: RscButton
		{
			...
			h = 0.0549786 * safezoneH;
			action = "[] spawn jey_deletebutton_heli";
		};
...
class jey_remover_tank
{
	...
	class controls 
	{
		...
		class remove_delete: RscButton
		{
			...
			w = 0.0802083 * safezoneW;
			h = 0.0549786 * safezoneH;
			action = "[] spawn jey_deletebutton_tank";
		};
		class RscListbox_1500: RscListbox
		{
			idc = 1500;
