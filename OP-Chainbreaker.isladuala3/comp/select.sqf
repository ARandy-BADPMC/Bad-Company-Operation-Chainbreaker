...
_tasks = ["Retrieve","Eliminate","Technology","Destroy","Annihilate and Destroy","Secure","Capture","Exterminate","Neutralize","Attack","Clear out","Neutralize2","Destroy Choppers","IDAP","Minefield"];
