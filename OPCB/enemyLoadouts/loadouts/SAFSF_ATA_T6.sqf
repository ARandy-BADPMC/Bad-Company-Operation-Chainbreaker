...
_this addVest "rhsusf_mbav_rifleman";
...
for "_i" from 1 to 2 do {_this addItemToBackpack "rhs_mag_maaws_HEAT";};
_this addHeadgear "rhsusf_protech_helmet_rhino";
_this addGoggles "rhsusf_shemagh2_od";
...
// "Set identity";
[_this,"WhiteHead_08","male04eng"] call BIS_fnc_setIdentity;
