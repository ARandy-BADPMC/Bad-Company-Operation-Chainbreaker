...
// "Add weapons";
_this addWeapon "hlc_rifle_G36A1AG36";
...
for "_i" from 1 to 7 do {_this addItemToBackpack "1Rnd_HE_Grenade_shell";};
for "_i" from 1 to 3 do {_this addItemToBackpack "1Rnd_SmokeBlue_Grenade_shell";};
...
// "Set identity";
[_this,"WhiteHead_12","male11eng"] call BIS_fnc_setIdentity;
