...
switch (toLower worldName) do {
	...
	case "lythium" : {
		...
		OPCB_InfantryGroups_Insurgents = [configfile >> "CfgGroups" >> "Indep" >> "LOP_AM" >> "Infantry"] call _configParser;

		OPCB_MechanizedGroups_Insurgents = [configfile >> "CfgGroups" >> "Indep" >> "LOP_AM" >> "Motorized"] call _configParser;
