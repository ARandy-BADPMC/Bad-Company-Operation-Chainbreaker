...
switch (toLower worldName) do {
	...
	case "lythium" : {
		...
		OPCB_InfantryGroups_Insurgents = [configfile >> "CfgGroups" >> "Indep" >> "LOP_ISTS" >> "Infantry"] call _configParser;

		OPCB_MechanizedGroups_Insurgents = [configfile >> "CfgGroups" >> "Indep" >> "LOP_ISTS" >> "Motorized"] call _configParser;
