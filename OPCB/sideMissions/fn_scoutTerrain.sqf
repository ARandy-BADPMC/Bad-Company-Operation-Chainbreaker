...
while {true} do {
	...
	[_taskId,west,["Radio Tower disrupting local communications. Take it down","Operation Scout Hill"], _taskMarker,"AUTOASSIGNED",10,true,true,"scout",true] call BIS_fnc_setTask;
