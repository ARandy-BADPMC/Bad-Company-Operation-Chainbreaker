...
[_taskId, west, [
	"Safely transport Ambulances carrying vital medical supplies to up to four FOBs. Navigate through enemy territory, coordinate convoy movements, and ensure the secure delivery of essential cargo. Enemy forces may attempt to intercept. In case of ambulance destruction, replacements can be purchased at the vehicle store.",
	"Operation Lifeline"
...
for "_i" from 1 to _noSupplyPoints do {
	...
	private _container = createVehicle ["C_VAN_02_MEDEVAC_F", getPos dropoffpoint1, [], 30, "NONE"];
