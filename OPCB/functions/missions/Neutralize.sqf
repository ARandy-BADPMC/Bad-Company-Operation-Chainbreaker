...
_taskcomp = [
	[
		...
		{_this call CHAB_fnc_enemySpawner;}
	],
	[
		"weap_factory",
...
_leader = _capturegroup createUnit [selectRandom OPCB_Commanders_Insurgents,  _base, [], 2, "NONE"];
...
[_leader,resistance] call _enemySpawnerFunction;
