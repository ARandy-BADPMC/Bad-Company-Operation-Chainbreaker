...
for "_i" from 0 to 3 do {
	_retries = 0;
	while {(surfaceIsWater _suitable or (_suitable select 0)<=100 or count _list > 0 or (_suitable select 1) >= 13000) and _retries < _maxRetries } do {
		_spot = _pos getPos [random [200,1000,1500], random 360];
